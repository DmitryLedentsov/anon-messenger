...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
  ...
  public void registerStompEndpoints(StompEndpointRegistry registry) {
    registry.addEndpoint(properties.getPath());
    registry.setErrorHandler(
        new StompSubProtocolErrorHandler() {
          ...
          private Message<byte[]> prepareErrorMessage(
              Message<byte[]> clientMessage, AppException apiError, String errorCode) {
            ...
            return MessageBuilder.createMessage(
                message != null ? message.getBytes() : "".getBytes(), accessor.getMessageHeaders());
          }
        });
  }
